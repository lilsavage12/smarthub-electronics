                        ...
                        >
                            ...
                            <div className="flex flex-col gap-6 relative z-10">
                                ...
                                <div className="flex flex-col gap-1">
                                    <h3 className="text-sm font-black italic tracking-tighter uppercase group-hover:text-primary transition-colors">{promo.name}</h3>
                                    <span className="text-[10px] font-bold text-muted-foreground uppercase opacity-60 tracking-widest truncate">
                                        {(promo.products?.length || 0) > 1 
                                            ? `${promo.products.length} ASSETS FOCUSED` 
                                            : (promo.products?.[0]?.name || promo.product?.name || "STOREFRONT WIDE")}
                                    </span>
                                </div>
                            ...
                            <div className="flex-1 p-8 md:p-14 flex flex-col gap-14 overflow-y-auto custom-scrollbar">
                                ...
                                <div className="flex flex-col gap-8">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-[11px] font-black uppercase tracking-widest text-foreground">Promotion Identity</span>
