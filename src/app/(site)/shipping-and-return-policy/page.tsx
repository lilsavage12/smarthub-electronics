...
export default async function ShippingAndReturnPolicyPage() {
    ...
    return (
        <ContentLayout 
            ...
            title={<>SHIPPING & <span className='text-indigo-500 '>RETURNS</span></>} 
            ...
            <section className="flex flex-col gap-12">
                <div className="flex flex-col gap-8">
                    <div className="flex items-center gap-4 text-primary">
                        <Truck size={24} />
                        <h2 className="text-3xl md:text-5xl font-black  tracking-tighter uppercase leading-none text-foreground">Logistics Information</h2>
                    </div>
                ...
                <div className="flex flex-col gap-8">
                    <h2 className="text-3xl md:text-5xl font-black  tracking-tighter uppercase leading-none text-foreground flex items-center gap-4">Return Standards</h2>
                    <p className="text-lg font-medium text-muted-foreground leading-relaxed">
                ...
                <div className="flex flex-col gap-8">
                    <h2 className="text-3xl md:text-5xl font-black  tracking-tighter uppercase leading-none text-foreground flex items-center gap-4">Refund Methodology</h2>
                    <p className="text-lg font-medium text-muted-foreground leading-relaxed">
